    ...
    <div class="admin-stat-card__header">
      ...
      <div class="admin-stat-card__icon">
        <svg v-if="icon === 'users'" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M12 15V13.5C12 12.6716 11.3284 12 10.5 12H7.5C6.67157 12 6 12.6716 6 13.5V15M15 12.75C15 11.0924 13.6569 9.75 12 9.75C11.4823 9.75 11 9.86427 10.56 1.06589M7.44 1.06589C6.99997 0.864274 6.51772 0.75 6 0.75C4.34315 0.75 3 2.09315 3 3.75C3 5.40685 4.34315 6.75 6 6.75C6.51772 6.75 6.99997 6.86427 7.44 6.65789M9 6.75C10.6569 6.75 12 5.40685 12 3.75C12 2.09315 10.6569 0.75 9 0.75C7.34315 0.75 6 2.09315 6 3.75C6 5.40685 7.34315 6.75 9 6.75Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
        </svg>
        <svg v-else-if="icon === 'activity'" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M1.5 9H4.5L6.75 4.5L9.75 13.5L12 9H15" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <svg v-else-if="icon === 'server'" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <rect x="3" y="2" width="12" height="5" rx="1.5" stroke="currentColor" stroke-width="1.2"/>
          <rect x="3" y="11" width="12" height="5" rx="1.5" stroke="currentColor" stroke-width="1.2"/>
        ...
        <svg v-else-if="icon === 'shield'" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M9 1.5L3 4.5V8.25C3 12.17 5.64 15.81 9 16.87C12.36 15.81 15 12.17 15 8.25V4.5L9 1.5Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <svg v-else width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M9 1.5V16.5M1.5 9H16.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
        </svg>
      </div>
    </div>
